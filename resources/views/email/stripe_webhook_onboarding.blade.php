                                        ...
                                        <tbody>
                                                ...
                                                <td style="word-break:break-word;font-size:0px;padding:0px 0px 20px;"
                                                    ...
                                                    <div
                                                        ...
                                                        <h2
                                                            ...
                                                            Hey {{ $name }},</h2>
                                                        <p>Cheers! Your account has been generated successfully. Your
                                                            auto generated login credentials are as below.</p>
                                                        <p>email : {{ $email }}<br>
                                                            password : {{ $password }}</p>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div
                                                        style="cursor:auto;color:#737F8D;font-family:Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif;font-size:16px;line-height:24px;text-align:left;">
                                                        <p>We hope you have smooth onboarding experience, If you have
                                                            any issue you can reach out to us. </p>
                                                        <p>Support Email : <a href="mailto: yaraa.bizsuite@gmail.com">
                                                                yaraa.bizsuite@gmail.com</a></p>
                                                        </p>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <div
                                                        style="font-family:&quot;-apple-system&quot;,BlinkMacSystemFont,&quot;Segoe UI&quot;,Roboto,&quot;Helvetica Neue&quot;,Helvetica,Arial,sans-serif;font-size:11px;font-weight:300;color:#9ca6af;text-align:left;line-height:17px">
                                                        <hr />
                                        ...
                                        <td style="word-break:break-word;font-size:0px;padding:0px;" align="center">
                                            <div
                                                ...
                                                Sent by Yaraa • <a href="https://yaraai.com/blog/"
                                                    style="color:#1EB0F4;text-decoration:none;" target="_blank">check
                                                    our blog</a>
                                                <!-- • <a
