...
use App\Rules\PitchGroundCodeCheck;
...
class PitchGroundSignupController extends Controller
{
    public function signup(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'code' => ['required', new PitchGroundCodeCheck],
            'phone' => 'required',
            'country' => 'required'
        ]);
        ...
        try {
            ...
            $code = PitchGroundCode::whereCode($request->code)->first();
            ...
            $tenant = Tenant::create([
                ...
                "provider" => Tenant::PROVIDER_PG,
                "pitchground_code_id" => null,
                "phone" => $request->phone,
            ...
            if ($user) {
                ...
                //update tenant
                $tenant->setup = true;
                $tenant->pitchground_code_id = $code->id;
                $tenant->save();
            }
