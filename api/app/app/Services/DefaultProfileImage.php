...
class DefaultProfileImage
{
	 ...
	 * @throws Exception
	 */
	public static function create ($name = '', $size = 96, $background_color = '#666', $text_color = '#FFF', $font_file = '../../../font/OpenSans-Semibold.ttf')
	{
		if (strlen($name) <= 0) {
		...
		$font_file = base_path('public')."/font/OpenSans-Semibold.ttf";
		...
		$background_color = sprintf('#%06X', mt_rand(0x000000, 0xFFFFFF / 1.5));
