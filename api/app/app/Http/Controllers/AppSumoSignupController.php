...
use App\Models\User;
use App\Rules\AppSumoCodeCheck;
use Carbon\Carbon;
...
class AppSumoSignupController extends Controller
{
    public function signup(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'code' => ['required', new AppSumoCodeCheck],
            'phone' => 'required',
            'country' => 'required',
        ]);
        ...
        try {
            ...
            $tenant = Tenant::create([
                ...
                "provider" => Tenant::PROVIDER_AS,
                "app_sumo_code_id" => null,
                "phone" => $request->phone,
            ...
            if ($user) {
                ...
                //redeem code
                $code = AppSumoCode::whereCode($request->code)->first();
                $code->redeemed = "yes";
                ...
                //update tenant
                $tenant->setup = true;
                $tenant->app_sumo_code_id = $code->id;
                $tenant->save();
            }
