...
$app->singleton('CreateDPWithLetter', App\Services\DefaultProfileImage::class);
$app->singleton('FcmDynamicLink', App\Services\FcmGenerateDynamicLink::class);
// $app->singleton('TaskGroupFilter', App\Services\TaskFilter::class);
